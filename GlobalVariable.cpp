...
void CGlobalVariable::CenterAlign(int from, int to)
{
	D3DXVECTOR3 center = meshes_[to].GetOrgin();
	D3DXVECTOR3 pos = meshes_[to].GetPos();

	meshes_[from].ChangeOrgin(center,pos);
